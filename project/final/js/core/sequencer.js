...
function loadSounds() {
    ...
    const soundPaths = [
        'assets/sounds/kicks/Kick-Drum-1.wav',           // Row 0: Kick
        'assets/sounds/snares/Snare-Drum-1.wav',         // Row 1: Snare
        'assets/sounds/hi_hats/Closed-Hi-Hat-1.wav',     // Row 2: Hi-hat
        'assets/sounds/percussion/Clap-1.wav',           // Row 3: Clap
        'assets/sounds/bass/Bass-C1-16bit.wav',          // Row 4: Bass
        'assets/sounds/bass/Bass-E1-16bit.wav',          // Row 5: Synth (using bass sample)
        'assets/sounds/percussion/Cowbell-1.wav',        // Row 6: FX 1
        'assets/sounds/percussion/Shaker-1.wav'          // Row 7: FX 2
    ];
